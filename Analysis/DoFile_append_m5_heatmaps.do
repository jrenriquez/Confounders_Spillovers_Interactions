...
cap confirm file "heatmaps_`y'_`r'_`t'_`l'_pds.csv"

if _rc==0 {

display "file exists"
display "heatmaps_`y'_`r'_`t'_`l'_pds.csv"

import delimited "heatmaps_`y'_`r'_`t'_`l'_pds.csv", clear 

rename v1 graph
rename v2 coef

foreach var of varlist graph coef v3 {
...
save "heatmaps_`y'_`r'_`t'_`l'_pds.dta", replace
...
foreach r of local restrictions {
	...
	cap append using "heatmaps_`y'_`r'_`t'_`l'_pds.dta"
	cap erase "heatmaps_`y'_`r'_`t'_`l'_pds.dta"
	cap erase "heatmaps_`y'_`r'_`t'_`l'_pds.csv"
}
}
}
}
