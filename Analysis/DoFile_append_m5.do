...
if "`y'" == "mr1" | "`y'" == "mr2" {
import delimited "`y'_`r'_fs_m5_pds.csv", clear varnames(3) 
}

if "`y'" == "covid_1_pc" {
import delimited "`y'_`r'_rf_m5_pds.csv", clear varnames(3) 
}
...
replace graph = "lasso interactions " + graph if graph != ""
...
foreach r of local restriction {
foreach y of local predicted {
	cap append using "`y'_`r'_m5.dta"
	cap append using "`y'_`r'_m5_7.dta"
	cap erase "`y'_`r'_m5.dta"
	cap erase "`y'_`r'_m5_7.dta"
}
}

* Sort and export
gen orderaux = 1 if iden3 == "m5"
replace orderaux = 2 if iden3 == "m5_7"
...
export delimited "m5.csv", replace
...
if "`y'" == "mr1" | "`y'" == "mr2" {
erase "`y'_`r'_fs_m5_pds.csv" 
}

if "`y'" == "covid_1_pc" {
erase "`y'_`r'_rf_m5_pds.csv"
}
